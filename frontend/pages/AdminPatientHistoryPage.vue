<template>
  <div class="patient-history-page">
    ...
    <header class="page-header">
      ...
      <p class="page-subtitle">Complete medical record and appointment history</p>
    </header>
        ...
        <div class="history-card" v-for="(h, i) in history" :key="i">
          ...
          <div class="history-details">
            <div class="detail-section">
              <h4>Diagnosis</h4>
              <p class="detail-content">{{ h.diagnosis || "No diagnosis recorded" }}</p>
            </div>

            <div class="detail-section">
              <h4>Prescription</h4>
              <p class="detail-content">{{ h.prescription || "No prescription given" }}</p>
            </div>

            <div class="detail-section">
              <h4>Medical Notes</h4>
              <p class="detail-content">{{ h.notes || "No additional notes" }}</p>
            </div>
          </div>
        </div>
      </div>
